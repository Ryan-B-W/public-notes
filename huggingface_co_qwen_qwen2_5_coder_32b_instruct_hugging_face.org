:PROPERTIES:
:ID:       12f858c4-4a9f-4cd0-ae0b-bf9428ebe769
:ROAM_REFS: https://huggingface.co/Qwen/Qwen2.5-Coder-32B-Instruct
:END:
#+title: (huggingface.co) Qwen/Qwen2.5-Coder-32B-Instruct · Hugging Face
...
#+begin_quote
  ...
  *This repo contains the instruction-tuned 32B Qwen2.5-Coder model*, which has the following features:
  ...
  - Context Length: Full 131,072 tokens
    - Please refer to [[https://huggingface.co/Qwen/Qwen2.5-Coder-32B-Instruct#processing-long-texts][this section]] for detailed instructions on how to deploy Qwen2.5 for handling long texts.
