:PROPERTIES:
:ID:       33ab8f83-cd31-4941-ba4e-1fa883f9edd0
:ROAM_REFS: https://davideshay.github.io/groceries/
:END:
#+title: (davideshay.github.io) Specifically Clementines
#+filetags: :open_source:inventory_management:software:website:
...
#+begin_quote
  ...
  ** Features
  ...
  - Recipe support, so that a group of items can be added to a shopping list at once. Includes support for importing existing recipes from [[https://tandoor.dev/][Tandoor]]

  ** Demo

  If you'd like to take a look at the app without going through a local install, check out the demo site and login instructions at: [[https://www.specificallyclementines.com/][Specifically Clementines]]
