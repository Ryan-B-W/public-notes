:PROPERTIES:
:ID:       bbb9249f-c536-41e0-9b48-7046483b9295
:ROAM_ALIASES: AIM-349
:END:
#+title: Scheme: An Interpreter for Extended Lambda Calculus
#+filetags: :scheme:lisp:computer_science:science_paper:

* (dspace.mit.edu) SCHEME: An Interpreter for Extended Lambda Calculus :website:
:PROPERTIES:
...
:END:
* [[id:db07fce0-3feb-4878-9fd2-8cbc6b5e998c][(en.wikisource.org) Scheme: An Interpreter for Extended Lambda Calculus - Wikisource, the free online library]]
