:PROPERTIES:
:ID:       f92dea4d-2a60-48d4-9b79-016da0a8019b
:ROAM_REFS: https://research.cs.wisc.edu/vertical/papers/2013/hpca13-isa-power-struggles.pdf
:END:
#+title: (research.cs.wisc.edu) Power Struggles: Revisiting the RISC vs. CISC Debate on Contemporary ARM and x86 Architectures (hpca13-isa-power-struggles.pdf)
#+filetags: :computer_science:electronics:mime_type_application_pdf:science_paper:website:
