...
**** Session 26, [2025-09-14 Sun 15:00-16:00]
***** Current section [[id:eecde4f8-9302-4eb7-a09b-6ee1217b3414][(sarabander.github.io) SICP, 2e: 5.5 Compilation]]
***** [[id:773cc4e7-7069-4e3a-9fc7-6896b1cda802][(www.amazon.com) Compiling with Continuations: Appel, Andrew W.: 9780521033114: Amazon.com: Books]]
***** [[id:8ac67c01-5578-4ca2-bf86-df0b0210667b][(sarabander.github.io) SICP, 2e: 5.5, Footnote 321]]
***** [[id:da4c3b80-24fe-4817-8443-87a1ccee7910][(sarabander.github.io) SICP, 2e: 4.3 Variations on a Scheme — Nondeterministic Computing]], [[https://sarabander.github.io/sicp/html/4_002e3.xhtml#Execution-procedures-and-continuations][4.3.3, Implementing the Amb Evaluator: Execution procedures and continuations]]
Introduces /continuation procedures/.
***** [[id:40759654-023b-4d8a-8901-922f0d1ae9ef][(wiki.c2.com) Events Are Not Call Backs]]
***** [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Hooks.html][Hooks (GNU Emacs Manual)]] from [[id:dfc03017-bfd1-489b-9e12-d538cdbdbe08][(www.gnu.org) Top (GNU Emacs Manual)]]
#+begin_quote
...
#+end_quote
***** [[id:c0074cfd-adf3-4fb6-80aa-a38dbb0f8fb7][(foldoc.org) callback from FOLDOC]]
***** [[id:7552890f-362e-4e66-a398-be2066aece7e][(www.ccs.neu.edu) Lexer and Parser Generators in Scheme (scmparse.pdf)]]
**** Session 27, [2025-09-21 Sun 15:00-16:00]
***** Current section [[id:eecde4f8-9302-4eb7-a09b-6ee1217b3414][(sarabander.github.io) SICP, 2e: 5.5 Compilation]]
***** [[id:8a3da5f5-02f0-4779-ac71-7cc89c3053fe][(sarabander.github.io) SICP, 2e: 5.5, Footnote 319]]
***** [[id:8ac67c01-5578-4ca2-bf86-df0b0210667b][(sarabander.github.io) SICP, 2e: 5.5, Footnote 321]]
***** [[id:d9915b4f-989f-4f64-95db-d96fff9d5687][(sarabander.github.io) SICP, 2e: 5.5, Footnote 325]]
***** [[id:60cefeb2-1cfb-4222-95be-a50389e5cfb3][(sarabander.github.io) SICP, 2e: 5.5, Footnote 329]]
***** [[id:81e74713-e685-43d3-a29a-4d70234e4576][(sarabander.github.io) SICP, 2e: 5.5, Footnote 337]]
***** [[id:c16fc576-4669-4afc-8842-7b7d2c302345][(en.wikipedia.org) Rope (data structure) - Wikipedia]]
***** [[id:7c23b51b-d60a-4d2e-90b4-9c95743f2bfc][(en.wikipedia.org) Late binding - Wikipedia]]
***** [[https://docs.scheme.org/schintro/schintro_133.html#SEC209][An Introduction to Scheme and its Implementation - Records and Object Orientation - Simple Uses of OOP Objects - Late Binding]] from [[id:0027e55d-f7a5-4b05-bdd4-9f015ba72bad][(docs.scheme.org) An Introduction to Scheme and its Implementation - Table of Contents]]
***** [[https://standards.scheme.org/corrected-r5rs/r5rs-Z-H-4.html][Revised^5 Report on the Algorithmic Language Scheme - Chapter 1: Overview of Scheme]] from [[id:7e993f6e-28c9-4afe-8906-2542f13cd5c1][(standards.scheme.org) Revised^5 Report on the Algorithmic Language Scheme]]
Again, for the definition of latent vs. manifest types.
***** [[id:465976e9-5be6-4062-bcb6-25ea0cb0ebfc][(en.wikipedia.org) Ada (programming language) - Wikipedia]]
***** [[id:86ed610a-56b0-4f67-92a4-17d214742a08][(en.wikipedia.org) SPARK (programming language) - Wikipedia]]
***** [[id:5dfe39dc-7d6c-47b9-ae2c-23e72e78ac2c][(en.wikipedia.org) Rice–Shapiro theorem - Wikipedia]]
***** [[id:c5d685f1-c146-4cc4-a8ce-0b552c1f199c][(austral-lang.org) Introduction to Linear Types]]
***** [[https://ada-lang.io/docs/arm/AA-3/AA-3.2/][3.2. Types and Subtypes | ada-lang.io, an Ada community site]] from [[id:0f070022-adfb-41f3-ac0d-8834f1b6cb1d][(ada-lang.io) Annotated Ada Reference Manual | ada-lang.io, an Ada community site]]
From the looks of this documentation, [[id:0d2ef242-5322-4982-ac3b-e35af271ded1][Ada]] uses latent types, like [[id:6246f8d4-6cd4-489d-b19f-9c1142b51b60][Scheme]] or [[id:84541e39-06cb-47bb-b71d-a298944d2764][Python]], rather than manifest types like [[id:c46eea5e-e2d2-4a21-bafe-74b6751292d2][C]] or [[id:e68f44a7-29bb-4d02-a5d9-a94ba0e757e4][Java]]:
#+begin_quote
...
#+end_quote
***** [[id:033793dd-a066-4f92-9834-c403720b2b0a][(www.infoq.com) Null References: The Billion Dollar Mistake - InfoQ]]
** [[id:59af449a-11bf-47ff-8608-fd6977dc3648][The Lambda Papers]]
*** [[id:1123e3d6-6f9f-4fa8-b001-1a39b23fc4ed][Scheme: An Interpreter for Extended Lambda Calculus (AIM-349)]]
**** Session 1, [2025-10-26 Sun 15:00-16:00]
Covered through section 3.  Will resume with section 4 next session.
**** Session 2, [2025-11-02 Sun 15:00-16:00]
Continuing, starting from section 4.
***** [[id:bbb9249f-c536-41e0-9b48-7046483b9295][Scheme: An Interpreter for Extended Lambda Calculus]]
***** [[id:4ce14cbe-3b40-41af-bf7c-b4677450f635][(www.youtube.com) Oopsla Conference: Growing a Language - YouTube]]
***** [[id:21d092e3-ec63-4cea-93de-116f4c89328d][(standards.scheme.org) Scheme Standards]]
***** [[id:bc4f5e4a-5bb9-47f7-8086-d12236fe793f][Structure and Interpretation of Computer Programs]]
***** [[id:a7261a30-e151-4a38-831c-3b65470b32b6][(en.wikipedia.org) Funarg problem - Wikipedia]]
***** [[id:a9d1cdf8-12df-46e4-8b8d-d29ca70ded53][(en.wikipedia.org) ISWIM - Wikipedia]]
****** [[id:08fd057d-88a6-49f2-a39e-a44d8503ba82][(en.wikipedia.org) Peter Landin - Wikipedia]]
***** [[id:88f292a5-2e0a-4ae0-b713-a87550568a9a][(en.wikipedia.org) Maclisp - Wikipedia]]
****** [[id:73952436-c1a6-4cf4-8d6b-93eac0fc3e0d][(en.wikipedia.org) MIT Computer Science and Artificial Intelligence Laboratory - Wikipedia]]
***** [[id:be8b671a-2bb0-4e85-8116-70e1ace8641c][Recursive Functions of Symbolic Expressions and Their Computation by Machine, Part I]]
***** [[id:3130a06b-6bc8-4cd2-9829-7550536c8f4d][(texdraft.github.io) Hello]]
****** [[id:8e828444-d654-43f9-8430-1314204ced46][(texdraft.github.io) Lisp Compiler]]
****** [[id:7c937363-9ca9-4492-b2d6-5f7a18348633][(texdraft.github.io) Lisp compiler source]]
***** [[id:859eefb6-e694-4907-a5f8-bb5168627b62][(texdraft.github.io) LISP 1.5 Source]]
***** [[id:a41d9d91-ca31-4d67-965f-5f4266a7a943][(www.youtube.com) Def Con 31 - Backdoor in the Core - Altering Intel X86 Instruction Set at Runtime - Krog, Skovsende - YouTube]]
***** Next time, [[id:463d922c-d592-474d-a064-a803f58a55d0][Lambda: The Ultimate Imperative]]
