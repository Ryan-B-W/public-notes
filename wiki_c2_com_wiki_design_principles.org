:PROPERTIES:
:ID:       54a94e61-596d-4818-ae1b-3aaad3fc4b89
:ROAM_REFS: http://wiki.c2.com/?WikiDesignPrinciples
:END:
#+title: (wiki.c2.com) Wiki Design Principles
#+filetags: :information_management:www:website:

#+begin_quote
  * Wiki Design Principles

  Wiki has turned out to be much more than I'd imagined!  That is not to say that I didn't imagine a lot.  These are the design principles I sought to satisfy with the first release of Wiki.  -- [[http://wiki.c2.com/?WardCunningham][WardCunningham]] Note that this page is only a reconstruction from memory of intentions I held at the beginning.  Additional principles, like server robustness, have been forced upon me.
  ...
  - *Trust* - This is the most important thing in a wiki.  Trust the people, trust the process, enable trust-building.  Everyone controls and checks the content.  Wiki relies on the assumption that most readers have good intentions.  /But see: [[http://wiki.c2.com/?AssumeGoodFaithLimitations][AssumeGoodFaithLimitations]]/
